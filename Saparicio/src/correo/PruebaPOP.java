...
public class PruebaPOP {
    public static void main(String[] args) {
        ...
        String usuario="grupo10sa";
        //String contrasena="grupo0101";
        String contrasena="grupo10grupo10";
        String comando="";
        String linea="";
        int puerto=110;
        ...
        try{
            ...
            if( socket != null && entrada != null && salida != null ){
                ...
                //Muestra todos los mensajes no borrados con su longitud.
                comando="LIST \r\n";
                System.out.print("C : "+comando);
                salida.writeBytes( comando );
                ...
                //Da el número de mensajes no borrados en el buzón y su longitud total.
                comando = "STAT\r\n";
                System.out.print("C : " + comando);
                salida.writeBytes(comando);
                System.out.println("S : " + entrada.readLine());
                ...
                System.out.println("Introduzca el numero de mensaje a recuperar: ");

                //RETR <número> Solicita el envío del mensaje especificando el número (no se borra del buzón).
                comando = "RETR "+sc.nextInt()+"\r\n";
                System.out.print("C : " + comando);
                salida.writeBytes(comando);     

                String cadenita = "";
                cadenita = getMultiline(entrada);


                System.out.println("S : " + cadenita);
